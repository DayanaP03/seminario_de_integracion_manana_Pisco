# abstraccion.py
# como una clase se abtracta puede teener sus hojos pero no se van a intancias desde la clase padre 
...
class Forma(ABC):
    ...
    def area(self) -> float:
        ...
        #cuando se utlizada el pass puede utlizarlo como obligatoriamnete 
    @abstractmethod
